...
class MainWindow(qtw.QMainWindow):
    def __init__(self):
        ...
        self.theme_manager = ThemeManager(__file__)
        ...
        favIcon=create_svg_icon(__file__, "favourite_btn.png", size=40)
        ...
        self.albumArt_frame_layout.setContentsMargins(0, 0, 0, 0)
        ...
        repeatIcon=create_svg_icon(__file__, "loop.png", size=10)
        self.repeatOptions_btn.setIcon(repeatIcon)

        self.makeFavourite_btn=qtw.QPushButton("")
        favBtnIcon=create_svg_icon(__file__, "fav_btn.png", size=10)
        self.makeFavourite_btn.setIcon(favBtnIcon)

        self.shuffle_btn=qtw.QPushButton("")
        shuffleIcon=create_svg_icon(__file__, "shuffle_btn.png", size=10)
        self.shuffle_btn.setIcon(shuffleIcon)

        self.trackInfo_btn=qtw.QPushButton("")
        infoIcon=create_svg_icon(__file__, "track_info_btn.png", size=10)
        ...
        volumeIcon_img=load_and_scale_image(__file__, "speaker_btn.svg", size=14)
